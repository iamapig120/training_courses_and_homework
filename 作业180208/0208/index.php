...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <div id="profile-links"> Hello, <a href="#" title="Edit your profile"><?php echo $_SESSION['username']?></a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
        <br />
      ...
      <ul id="main-nav">
        ...
        <li> <a href="#" class="nav-top-item current">
          ...
          Articles </a>
          <ul>
            <li><a href="add.php">Write a new Article</a></li>
            <li><a class="current" href="index.php">Manage Articles</a></li>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="#" title="title"><?php echo $news['title'] ?></a></td>
                <td></td>
