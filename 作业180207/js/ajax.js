...
//     xmlhttp.open("GET",json_path,false);
//     xmlhttp.send();
//     var json = new Function("return" + xmlhttp.responseText)();
// //                var json = new eval("(" + xmlhttp.responseText + ")");
//     return json;
//     }
// var database = get_json("js/database.json");
// var file_path = database.file_path;
// var img_path = database.img_path;
// var type_database = database.type_database;
// var music_database = database.music_database;
